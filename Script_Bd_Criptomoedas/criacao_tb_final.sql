...
INSERT INTO tb_moedas SELECT Name,Symbol,Date,High,Low,Open,Close,Volume,Marketcap FROM tb_bitcoin;
INSERT INTO tb_moedas SELECT Name,Symbol,Date,High,Low,Open,Close,Volume,Marketcap FROM tb_cardano;
INSERT INTO tb_moedas SELECT Name,Symbol,Date,High,Low,Open,Close,Volume,Marketcap FROM tb_cosmos;
INSERT INTO tb_moedas SELECT Name,Symbol,Date,High,Low,Open,Close,Volume,Marketcap FROM tb_dogecoin;
INSERT INTO tb_moedas SELECT Name,Symbol,Date,High,Low,Open,Close,Volume,Marketcap FROM tb_ethereum;
INSERT INTO tb_moedas SELECT Name,Symbol,Date,High,Low,Open,Close,Volume,Marketcap FROM tb_litecoin;
INSERT INTO tb_moedas SELECT Name,Symbol,Date,High,Low,Open,Close,Volume,Marketcap FROM tb_monero;
INSERT INTO tb_moedas SELECT Name,Symbol,Date,High,Low,Open,Close,Volume,Marketcap FROM tb_polkadot;
INSERT INTO tb_moedas SELECT Name,Symbol,Date,High,Low,Open,Close,Volume,Marketcap FROM tb_solana;
INSERT INTO tb_moedas SELECT Name,Symbol,Date,High,Low,Open,Close,Volume,Marketcap FROM tb_stellar;
